...
if __name__ == '__main__':
    print(fibonacci(100))
```
![Меню](https://github.com/Ann-kurbatova/main/blob/Tema10/pic/1.jpg)
...
```
![Меню](https://github.com/Ann-kurbatova/main/blob/Tema10/pic/2.jpg)
...
```
![Меню](https://github.com/Ann-kurbatova/main/blob/Tema10/pic/3.jpg)
...
if __name__ == '__main__':
    ...
    check_name(name)
```
![Меню](https://github.com/Ann-kurbatova/main/blob/Tema10/pic/4.jpg)
...
if __name__ == '__main__':
    ...
    print('>> Сайт выключен')
```
![Меню](https://github.com/Ann-kurbatova/main/blob/Tema10/pic/5.jpg)
...
if __name__ == "__main__":
    fibonacci()
```
![Меню](https://github.com/Ann-kurbatova/main/blob/Tema10/pic/1s.jpg)
...
if result is not None:
    print(result)
```
![Меню](https://github.com/Ann-kurbatova/main/blob/Tema10/pic/2s.jpg)
...
if __name__ == '__main__':
    sum()
```
![Меню](https://github.com/Ann-kurbatova/main/blob/Tema10/pic/3s.jpg)
...
print(l)
```
![Меню](https://github.com/Ann-kurbatova/main/blob/Tema10/pic/4s.jpg)
...
```
![Меню](https://github.com/Ann-kurbatova/main/blob/Tema10/pic/5s.jpg)
