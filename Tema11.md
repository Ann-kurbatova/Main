...
for item in numbers:
  print(item)
```
![Меню](https://github.com/Ann-kurbatova/Main/blob/Tema11/pic/1.jpg)
...
for i in counter:
    print(i)
```
![Меню](https://github.com/Ann-kurbatova/Main/blob/Tema11/pic/2.jpg)
...
for i in a:
    print(i)
```
![Меню](https://github.com/Ann-kurbatova/Main/blob/Tema11/pic/3.jpg)
...
for i in b:
    print(i)
```
![Меню](https://github.com/Ann-kurbatova/Main/blob/Tema11/pic/4.jpg)
...
if __name__ == '__main__':
    ...
    for i in counter:
        print(i)
```
![Меню](https://github.com/Ann-kurbatova/Main/blob/Tema11/pic/5.jpg)
...
```
![Меню](https://github.com/Ann-kurbatova/Main/blob/Tema11/pic/1s.jpg)
...
```
![Меню](https://github.com/Ann-kurbatova/Main/blob/Tema11/pic/2s.jpg)
![Меню](https://github.com/Ann-kurbatova/Main/blob/Tema11/pic/3s.jpg)
